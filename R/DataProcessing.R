...
library(scDatasets)
library('Linnorm')
normalized_data =  function (raw_Data, min_Reads = 5, min_Cell = 0.1, min_Gene = 800,
                             log = T)
{
...
##################Biase_data###########################################
#Reading RDS files for rds file (muraro, yan) and download pollen data from scDatasets
...
#saving file in csv format, cells (annotation) in 'celltype' file, genes in 'data_gene' file 
